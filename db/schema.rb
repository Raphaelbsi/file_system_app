...
ActiveRecord::Schema[8.0].define(version: 2025_05_17_165159) do
  ...
  create_table "stored_files", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["directory_id"], name: "index_stored_files_on_directory_id"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "directories", "directories", column: "parent_id"
  add_foreign_key "stored_files", "directories"
end
